...
test.describe("Undo / redo", () => {
	...
	test("undo peels back successive typed edits; redo replays them", async ({
		page,
	}) => {
	...
	test("undo reverts a formatting edit without losing the text", async ({
		page,
	}) => {
	...
	test("multiple undos then redos converge back to the final state", async ({
		page,
	}) => {
	...
	test("redo availability clears once a new edit is made after undo", async ({
		page,
	}) => {
