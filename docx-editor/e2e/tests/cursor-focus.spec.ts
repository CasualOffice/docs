...
test.describe("Cursor Focus - Toolbar Interactions", () => {
	...
	test("cursor stays visible after clicking Italic button", async ({
		page,
	}) => {
		await editor.typeText("Test text");
	...
	test("cursor stays visible after clicking Underline button", async ({
		page,
	}) => {
		await editor.typeText("Test text");
	...
	test("cursor stays visible after clicking alignment buttons", async ({
		page,
	}) => {
		await editor.typeText("Test text");
	...
	test("can type immediately after clicking multiple toolbar buttons", async ({
		page,
	}) => {
		// Click Bold
		await page.getByTestId("toolbar-bold").click();
...
test.describe("Cursor Focus - Text Selection Preservation", () => {
	...
	test("text selection preserved when clicking Bold button", async ({
		page,
	}) => {
		// Type text
	...
	test("text selection preserved when using font family dropdown", async ({
		page,
	}) => {
		// Type text
	...
	test("text selection preserved when using font size dropdown", async ({
		page,
	}) => {
		// Type text
