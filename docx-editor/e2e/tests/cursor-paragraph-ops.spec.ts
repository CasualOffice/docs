...
test.describe("Cursor-Only List Operations", () => {
	...
	test("bullet list applies with cursor only (no selection)", async ({
		page,
	}) => {
		// Type text
	...
	test("numbered list applies with cursor only (no selection)", async ({
		page,
	}) => {
...
test.describe("Cursor-Only Alignment Operations", () => {
	...
	test("keyboard shortcut Ctrl+E centers with cursor only", async ({
		page,
	}) => {
...
test.describe("Cursor-Only Indentation Operations", () => {
	...
	test("outdent paragraph with cursor only (no selection)", async ({
		page,
	}) => {
