...
function createTemplateDocument(): Document {
	...
	body.content.push(
		...
		{ type: "paragraph", content: [], formatting: {} },
		{
			type: "paragraph",
			content: [
				{ type: "run", content: [{ type: "text", text: "{#hasDiscount}" }] },
			],
			formatting: {},
		},
		{
			...
			content: [
				{
					type: "run",
					content: [
						{ type: "text", text: "Discount applied: {discountPercent}%" },
					],
				},
			],
			formatting: {},
		...
		{ type: "paragraph", content: [], formatting: {} },
		{
			type: "paragraph",
			content: [
				{ type: "run", content: [{ type: "text", text: "Total: ${total}" }] },
			],
			formatting: {},
		},
		{ type: "paragraph", content: [], formatting: {} },
		{
			type: "paragraph",
			content: [
				{ type: "run", content: [{ type: "text", text: "Best regards," }] },
			],
			formatting: {},
		},
		{
			type: "paragraph",
			content: [
				{ type: "run", content: [{ type: "text", text: "{company.name}" }] },
			],
			formatting: {},
		},
	);
