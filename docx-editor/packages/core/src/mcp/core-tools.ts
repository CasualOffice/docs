		...
		try {
			...
			return {
				...
				content: [
					{
						type: "text",
						text: `Failed to load document: ${(error as Error).message}`,
					},
				],
			};
		}
		...
		try {
			...
			return {
				...
				content: [
					{
						type: "text",
						text: `Failed to save document: ${(error as Error).message}`,
					},
				],
			};
		}
		...
		try {
			...
			return {
				...
				content: [
					{
						type: "text",
						text: `Failed to insert text: ${(error as Error).message}`,
					},
				],
			};
		}
		...
		try {
			...
			return {
				...
				content: [
					{
						type: "text",
						text: `Failed to replace text: ${(error as Error).message}`,
					},
				],
			};
		}
		...
		try {
			...
			return {
				...
				content: [
					{
						type: "text",
						text: `Failed to delete text: ${(error as Error).message}`,
					},
				],
			};
		}
		...
		try {
			...
			return {
				...
				content: [
					{
						type: "text",
						text: `Failed to format text: ${(error as Error).message}`,
					},
				],
			};
		}
		...
		try {
			...
			return {
				...
				content: [
					{
						type: "text",
						text: `Failed to apply style: ${(error as Error).message}`,
					},
				],
			};
		}
