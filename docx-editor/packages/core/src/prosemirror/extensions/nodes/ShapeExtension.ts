		...
		parseDOM: [
			{
				...
				getAttrs(dom): ShapeAttrs {
					...
					return {
						...
						gradientAngle: el.dataset.gradientAngle
							? Number(el.dataset.gradientAngle)
							: undefined,
						...
						displayMode:
							(el.dataset.displayMode as ShapeAttrs["displayMode"]) ||
							undefined,
						cssFloat:
							(el.dataset.cssFloat as ShapeAttrs["cssFloat"]) || undefined,
						...
						shadowBlur: el.dataset.shadowBlur
							? Number(el.dataset.shadowBlur)
							: undefined,
						shadowOffsetX: el.dataset.shadowOffsetX
							? Number(el.dataset.shadowOffsetX)
							: undefined,
						shadowOffsetY: el.dataset.shadowOffsetY
							? Number(el.dataset.shadowOffsetY)
							: undefined,
						glowColor: el.dataset.glowColor || undefined,
						glowRadius: el.dataset.glowRadius
							? Number(el.dataset.glowRadius)
							: undefined,
					};
				},
			},
