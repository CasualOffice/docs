...
function extractFontsFromStyles(
	...
	if (styles.docDefaults) {
		...
		if (styles.docDefaults.pPr?.runProperties) {
			extractFontsFromTextFormatting(
				styles.docDefaults.pPr.runProperties,
				fonts,
			);
		}
	}
 ...
 */
function extractFontsFromHyperlink(
	hyperlink: Hyperlink,
	fonts: Set<string>,
): void {
 ...
 */
function extractFontsFromHeaderFooter(
	hf: HeaderFooter,
	fonts: Set<string>,
): void {
 ...
 */
function extractFontsFromFootnote(
	footnote: Footnote,
	fonts: Set<string>,
): void {
