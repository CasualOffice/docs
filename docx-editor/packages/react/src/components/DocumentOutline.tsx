...
export const OUTLINE_RESERVED_SPACE =
	OUTLINE_LEFT_OFFSET + OUTLINE_WIDTH + OUTLINE_PAGE_GAP;
	...
	return (
		<nav
			...
			style={{
				...
				transform: open
					? "translateX(0)"
					: `translateX(-${OUTLINE_LEFT_OFFSET + OUTLINE_WIDTH}px)`,
				...
				<Tooltip content={t("documentOutline.closeTitle")}>
					<button
						...
						style={{
							...
							flexShrink: 0,
							transition:
								"background var(--doc-anim-fast), color var(--doc-anim-fast)",
						}}
						onMouseEnter={(e) => {
							...
							>
								...
								{isParent ? (
									<button
										...
										aria-label={
											isCollapsed
												? t("documentOutline.expand")
												: t("documentOutline.collapse")
										}
