...
export function DocumentName({
	...
	return (
		<span className="relative inline-flex items-center min-w-[100px] max-w-[360px] leading-tight">
			<span
				aria-hidden
				className="invisible whitespace-pre px-2 text-base font-normal"
			>
				{sizerText || " "}
			</span>
			<input
								...
								<>
									{(
										[
											...
											{
												label: t("toolbar.sectionBreakEvenPage"),
												type: "evenPage",
											},
											{
												label: t("toolbar.sectionBreakOddPage"),
												type: "oddPage",
											},
										] as const
									).map((item) => (
										...
										submenuContent: (closeMenu: () => void) => (
											<>
												{(
													[
														{
															label: t("toolbar.shapeRectangle"),
															type: "rectangle",
														},
														{
															label: t("toolbar.shapeEllipse"),
															type: "ellipse",
														},
								...
								<>
									{(
										[
											...
											{
												label: t("toolbar.fieldCreateDate"),
												type: "CREATEDATE",
											},
...
export function TitleBar({ children }: TitleBarProps) {
	...
	return (
		...
		>
			...
			{rightItem && (
				<div className="flex items-center flex-shrink-0 px-3">{rightItem}</div>
			)}
		</div>
	);
}
