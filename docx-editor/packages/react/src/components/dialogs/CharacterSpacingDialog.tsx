...
export function CharacterSpacingDialog({
	...
	const [spacingByPt, setSpacingByPt] = useState<number>(
		Math.abs(twipsToPt(initialValue.spacing)),
	);
	...
	const [kerningEnabled, setKerningEnabled] = useState<boolean>(
		initialValue.kerning != null,
	);
	const [kerningPt, setKerningPt] = useState<number>(
		halfPtToPt(initialValue.kerning) || 12,
	);
				...
				>
					...
					<div style={bodyStyle}>
						...
						<div style={rowStyle}>
							...
							>
								<option value="normal">
									{t("dialogs.characterSpacing.normal")}
								</option>
								<option value="expanded">
									{t("dialogs.characterSpacing.expanded")}
								</option>
								<option value="condensed">
									{t("dialogs.characterSpacing.condensed")}
								</option>
							</select>
							<input
								type="number"
						...
						<div style={rowStyle}>
							...
							<select
								...
								value={positionMode}
								onChange={(e) =>
									setPositionMode(e.target.value as PositionMode)
								}
								style={inputStyle}
							...
							>
								...
								<option value="raised">
									{t("dialogs.characterSpacing.raised")}
								</option>
						...
						<div style={{ marginTop: 4 }}>
							...
							<div style={previewStyle}>
								{t("dialogs.characterSpacing.previewSample")}
							</div>
						</div>
					</div>
