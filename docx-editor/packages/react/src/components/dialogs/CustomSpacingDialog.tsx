...
export function CustomSpacingDialog({
	...
	const update = <K extends keyof CustomSpacingValue>(
		key: K,
		v: CustomSpacingValue[K],
	) => commit({ ...value, [key]: v });
			...
			<div style={bodyStyle}>
				<div>
					<div style={sectionHeadStyle}>
						{t("dialogs.customSpacing.lineSpacing")}
					</div>
				...
				<div>
					<div style={sectionHeadStyle}>
						{t("dialogs.customSpacing.paragraphSpacing")}
					</div>
					<div style={rowStyle}>
						...
						<input
							...
							onChange={(e) =>
								update("spaceBefore", ptToTwips(Number(e.target.value)))
							}
					...
					<div style={{ ...rowStyle, marginTop: 6 }}>
						...
						<input
							...
							onChange={(e) =>
								update("spaceAfter", ptToTwips(Number(e.target.value)))
							}
				...
				<div>
					<div style={sectionHeadStyle}>
						{t("dialogs.customSpacing.pagination")}
					</div>
