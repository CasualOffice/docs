...
const INPUT_STYLE: CSSProperties = {
	...
	color: "var(--doc-text)",
	transition:
		"border-color var(--doc-anim-fast), box-shadow var(--doc-anim-fast)",
};
		...
		<Dialog
			...
			title={
				<span id="hyperlink-dialog-title">
					{isEditing
						? t("dialogs.hyperlink.titleEdit")
						: t("dialogs.hyperlink.titleInsert")}
				</span>
			}
			width={520}
			...
			>
				{hasBookmarks && (
					...
					>
						<button
							...
							style={
								linkType === "url" ? TAB_BUTTON_ACTIVE_STYLE : TAB_BUTTON_STYLE
							}
				...
				{linkType === "bookmark" && (
					<div className="docx-hyperlink-dialog-field" style={FORM_GROUP_STYLE}>
						...
						>
							<option value="">
								{t("dialogs.hyperlink.bookmarkPlaceholder")}
							</option>
							{bookmarks.map((bm) => (
				...
				<div className="docx-hyperlink-dialog-field" style={FORM_GROUP_STYLE}>
					...
					<div style={HINT_TEXT_STYLE}>
						{t("dialogs.hyperlink.displayTextHint")}
					</div>
				</div>
