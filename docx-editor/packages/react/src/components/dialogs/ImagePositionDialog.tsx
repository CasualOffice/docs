					...
					<div style={bodyStyle}>
						...
						<div style={sectionStyle}>
							<div style={sectionLabelStyle}>
								{t("dialogs.imagePosition.horizontal")}
							</div>
							<div style={rowStyle}>
								...
								>
									<option value="align">
										{t("dialogs.imagePosition.alignment")}
									</option>
									<option value="offset">
										{t("dialogs.imagePosition.offset")}
									</option>
								</select>
							</div>
							{hMode === "align" ? (
								<div style={rowStyle}>
									...
									>
										...
										<option value="center">
											{t("dialogs.imagePosition.alignOptions.center")}
										</option>
										<option value="right">
							...
							<div style={rowStyle}>
								...
								>
									<option value="page">
										{t("dialogs.imagePosition.relativeOptions.page")}
									</option>
									<option value="column">
						...
						<div style={sectionStyle}>
							<div style={sectionLabelStyle}>
								{t("dialogs.imagePosition.vertical")}
							</div>
							<div style={rowStyle}>
								<label style={labelStyle}>
									{t("dialogs.imagePosition.position")}
							...
							<div style={rowStyle}>
								...
								>
									...
									<option value="line">
										{t("dialogs.imagePosition.relativeOptions.line")}
									</option>
								</select>
							</div>
						</div>
