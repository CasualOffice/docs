...
const DROP_ZONE_STYLE: CSSProperties = {
	...
	cursor: "pointer",
	transition:
		"border-color var(--doc-anim-slow), background-color var(--doc-anim-slow)",
	marginBottom: "16px",
};
							...
							{imageData ? (
								...
								<>
									...
									<div style={DROP_ZONE_TEXT_STYLE}>
										{t("dialogs.insertImage.uploadText")}
									</div>
							...
							<>
								<div style={FORM_GROUP_STYLE}>
									<label style={LABEL_STYLE}>
										{t("dialogs.insertImage.dimensions")}
									</label>
