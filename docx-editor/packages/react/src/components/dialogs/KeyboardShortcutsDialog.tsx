...
const DEFAULT_SHORTCUTS: KeyboardShortcut[] = [
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.findReplaceDescription",
		keys: "Ctrl+H",
		category: "editing",
	},
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.pastePlainTextDescription",
		keys: "Ctrl+Shift+V",
		category: "clipboard",
	},
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.strikethroughDescription",
		keys: "Ctrl+Shift+X",
		category: "formatting",
	},
	{
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.superscriptDescription",
		keys: "Ctrl+Shift+=",
		category: "formatting",
	},
	{
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.alignCenterDescription",
		keys: "Ctrl+E",
		category: "formatting",
	},
	{
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.increaseIndentDescription",
		keys: "Tab",
		category: "formatting",
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.decreaseIndentDescription",
		keys: "Shift+Tab",
		category: "formatting",
	},
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.selectParagraphDescription",
		keys: "Triple-click",
		category: "selection",
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.extendSelectionByWordDescription",
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.extendSelectionToLineEdgeDescription",
		keys: "Shift+Home/End",
		category: "selection",
	},
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.moveToLineStartDescription",
		keys: "Home",
		category: "navigation",
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.moveToLineEndDescription",
		keys: "End",
		category: "navigation",
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.moveToDocumentStartDescription",
		keys: "Ctrl+Home",
		category: "navigation",
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.moveToDocumentEndDescription",
		keys: "Ctrl+End",
		category: "navigation",
	},
	{
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.keyboardShortcutsDescription",
		keys: "Ctrl+/",
		altKeys: "F1",
		category: "view",
	},
	...
	// instead. Mirroring them here also lets the search field find them.
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.commandPaletteDescription",
		keys: "Ctrl+Shift+P",
		category: "view",
		common: true,
	},
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.startCommentDescription",
		keys: "Ctrl+Alt+M",
		category: "editing",
	},
	{
	...
	},
	{
		...
		descriptionKey:
			"dialogs.keyboardShortcuts.shortcuts.documentOutlineDescription",
		keys: "Ctrl+Shift+H",
		category: "view",
	},
	{
...
const ShortcutItem: React.FC<ShortcutItemProps> = ({
	...
	const formattedAltKeys = shortcut.altKeys
		? formatKeys(shortcut.altKeys)
		: null;
				...
				>
					...
					>
						{groupedShortcuts.length === 0 ? (
							...
							>
								{t("dialogs.keyboardShortcuts.noResults", {
									query: searchQuery,
								})}
							</div>
						) : (
									...
									<div>
										{shortcuts.map((shortcut) => (
											<ShortcutItem
												...
												shortcut={shortcut}
												translatedName={
													shortcut.nameKey ? t(shortcut.nameKey) : shortcut.name
												}
												translatedDescription={
					...
					>
						{(() => {
							const text = t("dialogs.keyboardShortcuts.pressEscToClose", {
								key: "Esc",
							});
