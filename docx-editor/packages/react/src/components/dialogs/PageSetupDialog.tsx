...
const PAGE_SIZES = [
	{
		labelKey: "dialogs.pageSetup.pageSizes.letter" as const,
		width: 12240,
		height: 15840,
	},
	{
		labelKey: "dialogs.pageSetup.pageSizes.a4" as const,
		width: 11906,
		height: 16838,
	},
	{
		labelKey: "dialogs.pageSetup.pageSizes.legal" as const,
		width: 12240,
		height: 20160,
	},
	{
		labelKey: "dialogs.pageSetup.pageSizes.a3" as const,
		width: 16838,
		height: 23811,
	},
	{
		labelKey: "dialogs.pageSetup.pageSizes.a5" as const,
		width: 8391,
		height: 11906,
	},
	{
		labelKey: "dialogs.pageSetup.pageSizes.b5" as const,
		width: 9979,
		height: 14175,
	},
	{
		labelKey: "dialogs.pageSetup.pageSizes.executive" as const,
		width: 10440,
		height: 15120,
	},
] as const;
					...
					<div style={bodyStyle}>
						...
						<div style={rowStyle}>
							...
							>
								...
								{sizeIndex < 0 && (
									<option value={-1}>{t("dialogs.pageSetup.custom")}</option>
								)}
							</select>
						</div>
						...
						<div style={rowStyle}>
							...
							>
								<option value="portrait">
									{t("dialogs.pageSetup.portrait")}
								</option>
								<option value="landscape">
									{t("dialogs.pageSetup.landscape")}
								</option>
							</select>
						</div>
								...
								<div style={rowStyle}>
									...
									>
										<ColorPicker
											mode="border"
											value={
												pageColor ? pageColor.replace(/^#/, "") : { auto: true }
											}
											onChange={(c) => {
												if (typeof c === "string")
