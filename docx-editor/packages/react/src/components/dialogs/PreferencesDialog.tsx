...
export interface PreferencesDialogProps {
	...
	onChange: <K extends keyof EditorPreferences>(
		key: K,
...
const switchPillStyle = (on: boolean): CSSProperties => ({
	...
	position: "relative",
	transition:
		"background var(--doc-anim-base), box-shadow var(--doc-anim-base)",
		...
		>
			<div style={bodyStyle}>
				...
				<ToggleRow
					...
					description={
						<>
							Symbol sequences (<code style={codeStyle}>(c) → ©</code>) and
							common-typo fixes (<code style={codeStyle}>teh → the</code>).
						</>
					}
				/>
			</div>
