...
export function TablePropertiesDialog({
	...
	const [bandedRows, setBandedRows] = useState<boolean>(
		!currentProps?.look?.noHBand,
	);
	const [bandedColumns, setBandedColumns] = useState<boolean>(
		!currentProps?.look?.noVBand,
	);
				...
				>
					...
					<div style={bodyStyle}>
						...
						<div style={rowStyle}>
							...
							>
								<option value="auto">
									{t("dialogs.tableProperties.widthTypes.auto")}
								</option>
								<option value="dxa">
									{t("dialogs.tableProperties.widthTypes.fixed")}
								</option>
								<option value="pct">
									{t("dialogs.tableProperties.widthTypes.percentage")}
								</option>
							</select>
						</div>
						...
						<div style={rowStyle}>
							...
							>
								<option value="left">
									{t("dialogs.tableProperties.alignOptions.left")}
								</option>
								<option value="center">
									{t("dialogs.tableProperties.alignOptions.center")}
								</option>
								<option value="right">
									{t("dialogs.tableProperties.alignOptions.right")}
								</option>
							</select>
						</div>
