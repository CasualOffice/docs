		...
		},
		{
			...
			icon: (
				...
				>
					...
					/>
					<path
						d="M10 6 4 12l6 6V6zM14 6v12l6-6-6-6z"
						fill="currentColor"
						opacity="0.85"
					/>
				</svg>
		...
		},
		{
			...
			icon: (
				...
				>
					...
					/>
					<path
						d="M6 10 12 4l6 6H6zM6 14h12l-6 6-6-6z"
						fill="currentColor"
						opacity="0.85"
					/>
				</svg>
...
export function ImagePropertiesSection({
	...
	const [w, setW] = useState<string>(
		width != null ? String(Math.round(width)) : "",
	);
	const [h, setH] = useState<string>(
		height != null ? String(Math.round(height)) : "",
	);
