...
const WRAP_OPTIONS: (Omit<IconGridOption, "label"> & {
...
function getActiveWrapValue(
	ctx: ImageWrapDropdownProps["imageContext"],
): string {
...
export function ImageWrapDropdown({
	...
	const currentOption =
		translatedOptions.find((o) => o.value === activeValue) ||
		translatedOptions[0];
