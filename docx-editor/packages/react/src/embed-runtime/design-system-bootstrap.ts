/**
 * Bootstraps the @schnsrw/design-system tokens inside the docx-editor
 * embed runtime. Same pattern as the sheet SDK — see that file for the
 * full reasoning. Keep the TOKENS_CSS literal in sync with
 * `@schnsrw/design-system@0.1.0`.
 */
